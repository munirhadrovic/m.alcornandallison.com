...
<html>
	<head>
        ...
        <title>Glen Ellyn Clinical Therapists  | Alcorn &amp; Allison Clinical Associates</title>
	...
	<body>
		...
		<div data-role="footer" data-theme="<?php echo $theme ?>" data-position="fixed">
            <h1>Powered by <a href="http://www.mobilegrows.com" rel="external">MobileGrows</a> | <a href="http://alcornandallison.com/" rel="external">Desktop Site</a></h1>
		...
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-alt-icon ui-btn-icon-right buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Glen Ellyn Clinical Therapists</a></div>
				</div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
              ...
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-alt-icon ui-btn-icon-right buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Our Approach</a></div>
				</div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-alt-icon ui-btn-icon-right buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Our Staff</a></div>
				</div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-alt-icon ui-btn-icon-right buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Services</a></div>
				</div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-alt-icon ui-btn-icon-right buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Resources</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
            ...
            <p><b>Glen Ellyn Clinical Therapists</b></p>
         <p>Hello and welcome to Alcorn & Allison Clinical Associates. Located in downtown Glen Ellyn, we are a small group of seasoned and uniquely trained clinicians who work with children, adolescents, adults, families and couples from a variety of theoretical orientations.</p>
            </div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		<!-- page 2 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
			...
			<div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
				<div class="ui-grid-solo ui-alt-icon" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu">
						<ul id="menu">
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Glen Ellyn Clinical Therapists</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">About</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Our Approach</a></li>
